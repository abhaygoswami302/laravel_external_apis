                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                    @foreach ($knownForMovies as $movie)
                        <div class="mt-4">
                            ...
                            @else
                            <a href="{{ route('tv.show', $movie['id']) }}"><img src="{{ $movie['poster_path'] }}" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150"></a>
                            <a href="{{ route('tv.show', $movie['id']) }}" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1">{{ $movie['title'] }}</a>
                            @endif 
                        </div>
                    @endforeach
                ...
                @foreach ($credits as $credit)
                    <li>
                        ...
                        <strong>
                         ...
                         as {{ $credit['character'] ? $credit['character'] : 'Not Available' }}
                     </li>
                @endforeach
